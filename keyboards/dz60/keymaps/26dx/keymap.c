...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    ...
    LAYOUT(
        ...
        _______, _______, TASKM  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL , KC_END , KC_PGDN, _______,          _______,
        _______,          _______, _______, _______,          TG(3)  ,          _______, _______, _______, _______,  KC_APP,          _______),
   ...
   */
    LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LSFT_T(KC_UP)  ,          _______,
        _______,          _______, _______, _______,          _______,          _______, _______, RALT_T(KC_LEFT), XXXXXXX, KC_DOWN,          RCTL_T(KC_RGHT)),
};
